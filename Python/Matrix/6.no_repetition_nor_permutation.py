...
def no_repetition_no_permutation(i_list: list)-> bool:
    """
    Given a list of list, check if some row is repeated or if they are permutation of other row
    :param i_list: The source matrix
    :return: Return True if there are no repeated or permutated row, False otherwise
    """
    i = 0
    while i < len(i_list):
        j=i+1
...
if __name__ == "__main__":
    print(no_repetition_no_permutation([[1,2,3],[4,5,6,7],[4,7,6],[7,8,9]]))