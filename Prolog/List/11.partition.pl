...
% partition(Pivot,IList,OLlist,ORlist):- Given a pivot, put the element from IList into OLlist if the given element is less than the Pivot, 
%                                           otherwise put into ORlist
